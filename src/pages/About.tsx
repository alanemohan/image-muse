  ...
  const features = [
    {
      ...
      description:
        "Uses Google Gemini API to generate intelligent metadata and captions for your images",
    },
    {
      icon: Lock,
      title: "Secure & Private",
      description:
        "All processing is secure. Images are stored locally on your device",
    },
    {
      icon: Code2,
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-12">
          ...
          <p className="text-xl text-slate-400 leading-relaxed">
            AI Image Metadata and Caption Generator is a powerful tool that uses
            artificial intelligence to automatically generate intelligent
            metadata, captions, and descriptions for your images.
          </p>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {features.map(({ icon: Icon, title, description }) => (
            <Card
              key={title}
              className="bg-slate-900/50 border-slate-700/50 hover:border-cyan-500/30 transition-colors"
            >
              ...
              <ol className="space-y-4">
                {[
                  ...
                  },
                  {
                    step: 2,
                    title: "AI Analysis",
                    desc: "Google Gemini API analyzes the image content",
                  },
                  {
                    step: 3,
                    title: "Generate Metadata",
                    desc: "Automatic captions, tags, and descriptions are created",
                  },
                  {
                    step: 4,
                    title: "Download Results",
                    desc: "Export images with watermarked captions or metadata",
                  },
                ].map(({ step, title, desc }) => (
          ...
          <Card className="bg-gradient-to-r from-cyan-900/20 to-purple-900/20 border-cyan-500/30">
            ...
            <CardContent className="space-y-3">
              <p className="text-slate-300">
                For help, documentation, or to report issues, visit our GitHub
                repository:
              </p>
              <a
                ...
                aria-label="View Image Muse source code on GitHub (opens in new tab)"
        ...
        <footer className="text-center text-slate-500 text-sm">
          ...
          <p className="mt-2">
            Made with passion for creators and developers
          </p>
        </footer>
      </div>
    </main>
